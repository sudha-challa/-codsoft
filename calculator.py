...
button_equal = tk.Button(
    master=frame, text="clear", padx=15,pady=5, width=3, command=clear)
button_equal.grid(row=6, column=0, pady=2)
button_clear = tk.Button(master=frame, text="=",
                         padx=15, pady=5, width=14, command=equal)
